...
namespace Exam.classes
{
    internal class Basket
    {
        ...
        public Basket( string name, int price, int qtte, string reference, DateTime dateexp, DateTime datecmd, string categorie, string fournisseur, int ammount, byte[] image)
        {
            this.id = ++count;
            this.name = name;
            this.price = price;
